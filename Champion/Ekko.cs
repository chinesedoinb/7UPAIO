...
namespace AIO7UP.Champions
{
    static class Ekko
    {
        ...
        public static void OnGameLoad()
        {
            ...
            ComboMenu.Add(new MenuKeyBind("CTurret", "Don't Use [E] UnderTurret", Keys.T, KeyBindType.Toggle));
        ...
        private static void Ultimate()
        {
            ...
            var enemies = GameObjects.EnemyHeroes.Where(e => e.IsValidTarget()).ToArray();
        ...
        {
            var Enemies = GameObjects.EnemyHeroes.Where(e => e.IsValidTarget(Q.Range) && !e.HasBuff("JudicatorIntervention") && !e.HasBuff("kindredrnodeathbuff") && !e.HasBuff("Undying Rage"));
        ...
        public static void Miscs()
        {
            ...
            var Enemies = GameObjects.EnemyHeroes.Where(e => e.IsValidTarget(Q.Range) && e.GetBuffCount("EkkoStacks") == 2 && !e.HasBuff("JudicatorIntervention") && !e.HasBuff("kindredrnodeathbuff") && !e.HasBuff("Undying Rage"));
