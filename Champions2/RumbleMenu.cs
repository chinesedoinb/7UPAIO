...
namespace ElRumble
{
    public class ElRumbleMenu
    {
        ...
        public static void Initialize()
        {
            ...
            heatMenu.Add(new MenuKeyBind("ElRumble.KeepHeat.Activated", "Auto harass", Keys.G, KeyBindType.Toggle));
            ...
            miscMenu.Add(new MenuKeyBind("ElRumble.Misc.R", "Manual R", Keys.T, KeyBindType.Press));
            Menu.Add(miscMenu);
            Menu.Attach();
        }
    }
